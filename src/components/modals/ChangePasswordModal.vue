...
// Import your new validation composable
    ...
    <div>
        <form @submit.prevent="handleChangePassword" class="flex flex-col gap-5">
            ...
            <div class="flex flex-col gap-2">
                <Input type="password" v-model="currentPassword" placeholder="Current Password" :class="{
                ...
                <transition enter-from-class="opacity-0 -translate-y-1" enter-to-class="opacity-100 translate-y-0"
                    ...
                    <p v-if="currentPasswordMessage" class="text-[12px] ml-2 text-red-500">
                        {{ currentPasswordMessage }}
                    </p>
                </transition>
            </div>
            ...
            <!-- New Password -->
            <div class="flex flex-col gap-2">
                <Input type="password" v-model="newPassword" placeholder="New Password" :class="{
                ...
                <transition enter-from-class="opacity-0 -translate-y-1" enter-to-class="opacity-100 translate-y-0"
                    enter-active-class="transition-all duration-150" leave-from-class="opacity-100 translate-y-0"
                    leave-to-class="opacity-0 -translate-y-1" leave-active-class="transition-all duration-150">
                    <p v-if="newPasswordMessage" class="text-[12px] ml-2 text-red-500">
                        {{ newPasswordMessage }}
                    </p>
                </transition>
            </div>
            ...
            <!-- Confirm Password -->
            <div class="flex flex-col gap-2">
                <Input type="password" v-model="confirmPassword" placeholder="Confirm New Password" :class="{
                ...
                <transition enter-from-class="opacity-0 -translate-y-1" enter-to-class="opacity-100 translate-y-0"
                    enter-active-class="transition-all duration-150" leave-from-class="opacity-100 translate-y-0"
                    leave-to-class="opacity-0 -translate-y-1" leave-active-class="transition-all duration-150">
                    <p v-if="confirmPasswordMessage" class="text-[12px] ml-2 text-red-500">
                        {{ confirmPasswordMessage }}
                    </p>
                </transition>
            </div>
